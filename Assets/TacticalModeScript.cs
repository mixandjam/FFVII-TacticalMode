...
public class TacticalModeScript : MonoBehaviour
{
    ...
    public void PlayVFX(VisualEffect visualEffect, bool shakeCamera, float shakeAmplitude = 2, float shakeFrequency = 2, float shakeSustain = .2f)
    {
        ...
        Camera.main.GetComponent<CinemachineImpulseSource>().m_ImpulseDefinition.m_AmplitudeGain = shakeAmplitude;
        Camera.main.GetComponent<CinemachineImpulseSource>().m_ImpulseDefinition.m_FrequencyGain = shakeFrequency;
        Camera.main.GetComponent<CinemachineImpulseSource>().m_ImpulseDefinition.m_TimeEnvelope.m_SustainTime = shakeSustain;
